...
### Who is this for?
We don't want to solve everything for everyone. Our focus is to help the persons/companies simplify their elt setup for fairly standard cases. 
...
- You are just starting out and would like to start with something lightweight like polars but don't want to lose the possibility to switch to another library like spark later on?
